...
namespace Task_1
{
    class Program
    {
        ...
        {
            FileStream fl = new FileStream(@"C:\git\Alikhan2011\Week2\input.txt", FileMode.Open, FileAccess.Read);//FileStream аркылы папканы окуга және жазуға  мүмкіндік аламыз
